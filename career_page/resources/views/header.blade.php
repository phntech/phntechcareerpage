    ...
    <section class="Header_section">
        <div class="container-fluid">
          ...
          <div class="header">
            <div class="row">
              <div
                class="col-sm-12 col-md-12 col-lg-6 col-12 header_details_div"
              >
                <p class="career_title">#Career</p>
              ...
              <div
                class="col-sm-12 col-md-12 col-lg-6 col-12 header_img_div"
              >
                <img
                  src="{{ asset('img/header_img.webp') }}"
                  alt="header_img"
                  class="header_img img-fluid"
                />
              </div>
            </div>
          </div>
